...
// Gate a staff write: requires a real DB connection AND a super-admin, admin or HR session. `action` names the operation for the error message ("Deleting a holiday", …).
