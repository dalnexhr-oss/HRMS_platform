// Base MongoDB collection validators and indexes. This file is maintained by hand. Cross-field
// constraints and additional indexes live in schema.mjs.
//
// Storage conventions:
// - UUIDs and text are strings; existing IDs retain their values.
// - Calendar dates use YYYY-MM-DD strings to avoid timezone shifts.
// - Times use HH:MM strings; timestamps use BSON dates.
// - Money uses Decimal128; integers use int or long.
// - Structured values use subdocuments, and enums list all accepted values.
// - Unique indexes enforce uniqueness. Reference indexes support lookups but do not enforce foreign
// keys.
//
// Cross-field checks belong in the $expr overrides or the action that writes the collection.
...
export const BASE_SCHEMA = {
  branches: {
    validator: {
      $jsonSchema: {
        bsonType: 'object',
        required: ['_id', 'name', 'state', 'geofence_radius_m', 'created_at'],
        properties: {
          _id: {
            bsonType: 'string',
          },
  ...
  punch_events: {
    validator: {
      $jsonSchema: {
        bsonType: 'object',
        required: ['_id', 'employee_id', 'punched_at', 'kind', 'source', 'created_at'],
        properties: {
          _id: {
            bsonType: 'string',
          },
    ...
    validator: {
      $jsonSchema: {
        ...
        properties: {
          ...
          status: {
            enum: ['P', 'LM', 'HD', 'L', 'WO', 'OH', 'AB', 'S', 'T', 'CO'],
          },
          punch_in: {
            bsonType: ['string', 'null'],
            pattern: '^[0-9]{2}:[0-9]{2}$',
  ...
  late_marks: {
    validator: {
      $jsonSchema: {
        bsonType: 'object',
        required: ['_id', 'employee_id', 'mark_date', 'auto_half_day', 'created_at'],
        properties: {
          _id: {
            bsonType: 'string',
          },
  ...
  holidays: {
    validator: {
      $jsonSchema: {
        bsonType: 'object',
        required: ['_id', 'holiday_date', 'name', 'created_at'],
        properties: {
          _id: {
            bsonType: 'string',
          },
  ...
  leave_balances: {
    validator: {
      $jsonSchema: {
        bsonType: 'object',
        required: ['_id', 'employee_id', 'year', 'type', 'balance'],
        properties: {
          _id: {
            bsonType: 'string',
          },
    ...
    validator: {
      $jsonSchema: {
        ...
        properties: {
          ...
          type: {
            enum: ['leave', 'site_visit', 'outdoor_duty', 'wfh', 'comp_off'],
          },
          leave_kind: {
            enum: ['PL', 'CL', 'SL', 'LWP', null],
          },
          start_date: {
            bsonType: 'string',
            pattern: '^[0-9]{4}-[0-9]{2}-[0-9]{2}$',
  ...
  payroll_runs: {
    validator: {
      $jsonSchema: {
        bsonType: 'object',
        required: ['_id', 'period_month', 'status', 'created_at'],
        properties: {
          _id: {
            bsonType: 'string',
          },
          ...
          status: {
            enum: ['draft', 'in_review', 'locked', 'paid'],
          },
          working_days: {
            bsonType: ['int', 'long', 'null'],
          },
    ...
    validator: {
      $jsonSchema: {
        ...
        properties: {
          ...
          status: {
            enum: ['draft', 'queued', 'generated', 'paid'],
          },
          pdf_url: {
            bsonType: ['string', 'null'],
          },
  ...
  pt_slabs: {
    validator: {
      $jsonSchema: {
        bsonType: 'object',
        required: ['_id', 'state', 'min_gross', 'amount', 'created_at'],
        properties: {
          _id: {
            bsonType: 'string',
          },
  ...
  notices: {
    validator: {
      $jsonSchema: {
        bsonType: 'object',
        required: ['_id', 'title', 'channel', 'created_at'],
        properties: {
          _id: {
            bsonType: 'string',
          },
  ...
  helpdesk_tickets: {
    validator: {
      $jsonSchema: {
        bsonType: 'object',
        required: ['_id', 'subject', 'status', 'created_at'],
        properties: {
          _id: {
            bsonType: 'string',
          },
  ...
  activity_log: {
    validator: {
      $jsonSchema: {
        bsonType: 'object',
        required: ['_id', 'event_type', 'message', 'metadata', 'occurred_at'],
        properties: {
          _id: {
            bsonType: 'string',
          },
  ...
  policies: {
    validator: {
      $jsonSchema: {
        bsonType: 'object',
        required: ['_id', 'title', 'body', 'version', 'published', 'created_at', 'updated_at'],
        properties: {
          _id: {
            bsonType: 'string',
          },
  ...
  policy_acknowledgements: {
    validator: {
      $jsonSchema: {
        bsonType: 'object',
        required: ['_id', 'policy_id', 'employee_id', 'acknowledged_at'],
        properties: {
          _id: {
            bsonType: 'string',
          },
    ...
    validator: {
      $jsonSchema: {
        ...
        properties: {
          ...
          purpose: {
            enum: ['travel', 'material_purchase', 'other'],
          },
          source_medium: {
            bsonType: ['string', 'null'],
          },
          ...
          status: {
            enum: ['pending', 'approved', 'rejected', 'paid', 'finance_review'],
          },
          reviewed_by: {
            bsonType: ['string', 'null'],
          },
  ...
  comp_offs: {
    validator: {
      $jsonSchema: {
        bsonType: 'object',
        required: ['_id', 'employee_id', 'earned_date', 'status', 'created_at'],
        properties: {
          _id: {
            bsonType: 'string',
          },
          ...
          status: {
            enum: ['available', 'applied', 'used', 'expired'],
          },
          used_date: {
            bsonType: ['string', 'null'],
            pattern: '^[0-9]{4}-[0-9]{2}-[0-9]{2}$',
  ...
  notifications: {
    validator: {
      $jsonSchema: {
        bsonType: 'object',
        required: ['_id', 'recipient_id', 'kind', 'title', 'created_at'],
        properties: {
          _id: {
            bsonType: 'string',
          },
  ...
  notice_reads: {
    validator: {
      $jsonSchema: {
        bsonType: 'object',
        required: ['_id', 'notice_id', 'employee_id', 'read_at'],
        properties: {
          _id: {
            bsonType: 'string',
          },
  ...
  helpdesk_ticket_comments: {
    validator: {
      $jsonSchema: {
        bsonType: 'object',
        required: ['_id', 'ticket_id', 'author_is_staff', 'body', 'created_at'],
        properties: {
          _id: {
            bsonType: 'string',
          },
  ...
  assets: {
    validator: {
      $jsonSchema: {
        bsonType: 'object',
        required: ['_id', 'desktop_name', 'created_at', 'updated_at'],
        properties: {
          _id: {
            bsonType: 'string',
          },
  ...
  item_assignments: {
    validator: {
      $jsonSchema: {
        bsonType: 'object',
        required: ['_id', 'item_id', 'quantity', 'assigned_date', 'returned', 'created_at'],
        properties: {
          _id: {
            bsonType: 'string',
          },
  ...
  cron_run_log: {
    validator: {
      $jsonSchema: {
        bsonType: 'object',
        required: ['_id', 'job', 'run_key', 'ran_at'],
        properties: {
          _id: {
            bsonType: 'string',
          },
  ...
  asset_assignments: {
    validator: {
      $jsonSchema: {
        bsonType: 'object',
        required: ['_id', 'asset_id', 'assigned_date', 'returned', 'created_at'],
        properties: {
          _id: {
            bsonType: 'string',
          },
  ...
  asset_maintenance: {
    validator: {
      $jsonSchema: {
        bsonType: 'object',
        required: ['_id', 'asset_id', 'maint_date', 'created_at'],
        properties: {
          _id: {
            bsonType: 'string',
          },
  ...
  reimbursement_events: {
    validator: {
      $jsonSchema: {
        bsonType: 'object',
        required: ['_id', 'claim_id', 'action', 'metadata', 'occurred_at'],
        properties: {
          _id: {
            bsonType: 'string',
          },
  ...
  leave_balance_adjustments: {
    validator: {
      $jsonSchema: {
        bsonType: 'object',
        required: ['_id', 'employee_id', 'year', 'type', 'delta', 'reason', 'created_at'],
        properties: {
          _id: {
            bsonType: 'string',
          },
  ...
  approval_steps: {
    validator: {
      $jsonSchema: {
        bsonType: 'object',
        required: ['_id', 'request_id', 'step_no', 'approver_role', 'status', 'created_at'],
        properties: {
          _id: {
            bsonType: 'string',
          },
  ...
  employee_documents: {
    validator: {
      $jsonSchema: {
        bsonType: 'object',
        required: ['_id', 'employee_id', 'storage_path', 'uploaded_at'],
        properties: {
          _id: {
            bsonType: 'string',
          },
  ...
  onboarding_template_items: {
    validator: {
      $jsonSchema: {
        bsonType: 'object',
        required: ['_id', 'template_id', 'seq', 'title'],
        properties: {
          _id: {
            bsonType: 'string',
          },
  ...
  onboarding_tasks: {
    validator: {
      $jsonSchema: {
        bsonType: 'object',
        required: ['_id', 'employee_id', 'title', 'status', 'created_at', 'updated_at'],
        properties: {
          _id: {
            bsonType: 'string',
          },
  ...
  acknowledgements: {
    validator: {
      $jsonSchema: {
        bsonType: 'object',
        required: ['_id', 'employee_id', 'document_kind', 'signed_name', 'signed_at'],
        properties: {
          _id: {
            bsonType: 'string',
          },
  ...
  exit_cases: {
    validator: {
      $jsonSchema: {
        bsonType: 'object',
        required: ['_id', 'employee_id', 'stage', 'created_at', 'updated_at'],
        properties: {
          _id: {
            bsonType: 'string',
          },
  ...
  exit_clearance_items: {
    validator: {
      $jsonSchema: {
        bsonType: 'object',
        required: ['_id', 'exit_case_id', 'area', 'cleared', 'created_at'],
        properties: {
          _id: {
            bsonType: 'string',
          },
  ...
  exit_interviews: {
    validator: {
      $jsonSchema: {
        bsonType: 'object',
        required: ['_id', 'exit_case_id', 'question', 'created_at'],
        properties: {
          _id: {
            bsonType: 'string',
          },
  ...
  knowledge_transfer_items: {
    validator: {
      $jsonSchema: {
        bsonType: 'object',
        required: ['_id', 'exit_case_id', 'task', 'status', 'created_at'],
        properties: {
          _id: {
            bsonType: 'string',
          },
  ...
  role_tab_access: {
    validator: {
      $jsonSchema: {
        bsonType: 'object',
        required: ['role', 'slug', 'allowed', 'updated_at'],
        properties: {
          role: {
            enum: ['super_admin', 'admin', 'hr', 'manager', 'employee'],
          },
  ...
  user_tab_access: {
    validator: {
      $jsonSchema: {
        bsonType: 'object',
        required: ['user_id', 'slug', 'allowed', 'updated_at'],
        properties: {
          user_id: {
            bsonType: 'string',
          },
