...
// Open a notice's PDF in a fresh tab. Claims the tab inside the click gesture (signing needs a server round trip), without 'noopener' in the features — that makes window.open() return null and would navigate THIS tab instead.
