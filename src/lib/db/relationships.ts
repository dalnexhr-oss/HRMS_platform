...
export interface Relationship {
  ...
  foreignField: string;
  // Whether many foreign rows can match one local row. Decides the shape PostgREST would have returned, and therefore whether the pipeline unwinds: a to-one embed is an object, a to-many is an array.
  toMany: boolean;
}
