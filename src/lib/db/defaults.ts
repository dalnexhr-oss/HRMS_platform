// ============================================================================
// GENERATED by scripts/gen-defaults.mjs — do not edit by hand.
//
// Postgres applied a column DEFAULT when an INSERT omitted it; MongoDB does
// not. Every value here was read out of the SQL DDL and coerced to the BSON
// type its collection validator declares, so an insert through pgcompat lands
// the same document Postgres would have stored.
//
// Regenerate with:  node scripts/gen-defaults.mjs
// ============================================================================
